...
const BeforeLogin = () => {
    ...
    <div className="container    mx-auto py-4 flex">
        ...
        >
          ...
          <div className=" ">
            {searchSuggestions.map((suggestion, index) => (
              <div
                key={index}
                className="cursor-pointer mt-5 hover:bg-gray-700 rounded-md px-3 py-1"
      ...
      <div className="flex bg-yellow-00 flex-grow ml-1/4 overflow-x-auto">
        ...
        <div className="w-[800px] translate-x-8 bg-fuchsia 0 ">
          <h2 className="text-3xl mt-28 font-Main font-bold ml-2 mb-4">Products</h2>
          <hr className=' w-1/5'/>
  ...
  <h2 className="text-2xl mt-28  font-semibold mb-4">Recommended Products on your Past Search</h2><hr className=' w-full'/>
  <div className="grid grid-cols-1 gap-4">
    {recommendedProducts.map(product => (
      <div
        key={product.id}
        className="bg-white  hover:shadow-xl mt-8 shadow-black transition ease-in-out rounded-lg   shadow-md p-4"
      >
